...
private val COLLECTIONS_FOREACH = CallableId(FqName("kotlin.collections"), FOREACH_NAME)
private val SEQUENCES_FOREACH = CallableId(FqName("kotlin.sequences"), FOREACH_NAME)
private val TEXT_FOREACH = CallableId(FqName("kotlin.text"), FOREACH_NAME)